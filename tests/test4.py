...
"""
    ...
    After 5 seconds the first node gets LEADER unset.

    Expected behaviour:
        All nodes get synchronized with the leader.
        After leader has become removed.
        It will synchronize with the rest of the nodes obtaining the higher
        sync level. The other nodes will desync and sync with higher levels.
        The syncLevels will form steps.
"""
...
def main():
    ...
    send_leader(targets[0][0], targets[0][1], 255)
